...
const navImage = "assets/images/image-Photoroom.png";
const navbarContainer = document.getElementById('navbar');
if (navbarContainer) {
    const navItem = document.createElement('div');
    navItem.className = 'container fs-5';
    navItem.innerHTML = `
            <a class="navbar-brand fw-bold font-monospace" href="index.html"></a>
                <img src="${navImage}" alt="Logo" class="d-inline-block align-text-top" width="150" height="70">
            </a>
            <button class="navbar-toggler border-bottom" type="button" data-bs-toggle="collapse"
            ...
            <div class="collapse navbar-collapse justify-content-center text-center" id="navbarNavDropdown">
                <ul class="navbar-nav flex-lg-nowrap">
                    <div class="col-md-6 col-lg-4 ">
                        <li class="nav-item">
                            <a class="nav-link text-white " href="index.html"><i class="bi bi-house-door"></i>Home</a>
                        </li>
                    </div>
                    <div class=" col-md-6 col-lg-4 ">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="about.html"><i class="bi bi-info-circle"></i> About</a>
                        </li>
                    </div>
                    <div class="col-md-6 col-lg-4 ">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="shop.html"><i class="bi bi-info-circle"></i> Shop</a>
                        </li>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <li class="nav-item">
                            <a class="nav-link  text-white" href="contact.html"><i class="bi bi-info-circle"></i> Contacts</a>
                        </li>
                    </div>
                            <div class="col-md-6 col-lg-4 ">
                                <li class="nav-item">
